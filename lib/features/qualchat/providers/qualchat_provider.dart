...
class QualChatProvider extends ChangeNotifier {
  ...
  static final List<HeyYaRequest> _fallbackHeyYas = [
    HeyYaRequest(
      ...
      isSentByMe: true,
      viewCount: 3,
      compatibility: const CompatibilityBreakdown(
        interests: 94, vibe: 91, lifestyle: 89, values: 93,
      ),
      timeline: [
        TimelineEvent(
        ...
        TimelineEvent(
          ...
          description: 'Alex saw your Hey Ya',
          timestamp: DateTime(2026, 5, 10, 15, 45),
        ),
        TimelineEvent(
          type: TimelineEventType.viewed,
          description: 'Viewed your profile 3 times',
          timestamp: DateTime(2026, 5, 10, 16, 20),
          detail: '3 profile views',
        ),
      ],
    ),
    HeyYaRequest(
      ...
      viewCount: 8,
      compatibility: const CompatibilityBreakdown(
        interests: 90, vibe: 85, lifestyle: 87, values: 88,
      ),
      timeline: [
        TimelineEvent(
          type: TimelineEventType.sent,
        ...
        TimelineEvent(
          type: TimelineEventType.seen,
          description: 'You saw their Hey Ya',
    ...
    HeyYaRequest(
      ...
      viewCount: 1,
      compatibility: const CompatibilityBreakdown(
        interests: 82, vibe: 87, lifestyle: 80, values: 85,
      ),
    ),
    HeyYaRequest(
      id: 'h4',
    ...
    HeyYaRequest(
      ...
      viewCount: 12,
      compatibility: const CompatibilityBreakdown(
        interests: 92, vibe: 90, lifestyle: 88, values: 91,
      ),
      timeline: [
        TimelineEvent(
          type: TimelineEventType.sent,
        ...
        TimelineEvent(
          type: TimelineEventType.seen,
          description: 'You saw their Hey Ya',
          timestamp: DateTime(2026, 5, 6, 9, 0),
        ),
        TimelineEvent(
          type: TimelineEventType.matched,
          description: "It's a Match! 💘",
